public class CustomPathfind extends Pathfind {
	
	public CustomPathfind(Node startNode, Node endNode) {
	...
	public void searchForPath() {
		...
		do {
			...
			for (Node neighbor : neighboringNodes) {
				...
				if (neighbor.box.getFlag() != Box.BOX_QUEUED_FLAG && neighbor.box.getFlag() != Box.BOX_SEARCHED_FLAG && neighbor.box.getFlag() != Box.BOX_BARRIER_FLAG) {
