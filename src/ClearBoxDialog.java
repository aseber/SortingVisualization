...
public class ClearBoxDialog extends JDialog implements KeyListener {
	...
	JCheckBox barrierBoxesCheckBox;
	...
	private void initComponents() {
		...
		barrierBoxesCheckBox = new JCheckBox("Barrier Boxes");
		...
		contentPanel.setLayout(new FormLayout("3px, 100px, 5px, 100px, 5px", "5px, 25px, 5px, 25px, 5px, 25px, 5px, 25px, 5px, 25px, 5px, 25px, 5px, 50px"));
		
		contentPanel.add(searchedBoxesCheckBox, CC.xywh(2, 2, 3, 1));
		contentPanel.add(barrierBoxesCheckBox, CC.xywh(2, 4, 3, 1));
		contentPanel.add(shortBoxesCheckBox, CC.xywh(2, 6, 3, 1));
		contentPanel.add(startBoxCheckBox, CC.xywh(2, 8, 3, 1));
		contentPanel.add(endBoxCheckBox, CC.xywh(2, 10, 3, 1));
		contentPanel.add(queuedBoxesCheckBox, CC.xywh(2, 12, 3, 1));
	...
	private void AcceptButtonMouseCLicked() {
		...
		if (barrierBoxesCheckBox.isSelected()) {
			
			flags.add(Box.BOX_BARRIER_FLAG);
