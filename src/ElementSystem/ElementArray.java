...
public class ElementArray {
	...
	public ElementArray(int size, directions direction, orders order, uniqueness uniques, Counter inputCounter) { // Do we ever set the element index correctly?
		...
		if (uniques.getValue() <= uniqueness.NONE.getValue() || uniques.getValue() > uniqueness.ALL.getValue()) {
			...
			throw new IllegalArgumentException("Invalid uniques passed to ElementSystem.ElementArray constructor: " + uniques);
		...
		if (uniques == uniqueness.ALL) {
			...
			throw new IllegalArgumentException("Invalid uniqueness flag passed to ElementSystem.ElementArray constructor: " + uniques);
		...
		if (order == ElementArray.orders.SORTED) {} // Nothing to do!
			...
			throw new IllegalArgumentException("Invalid order flag passed to ElementSystem.ElementArray constructor: " + order);
